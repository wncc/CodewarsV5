...
class Archer(Troop):
    def __init__(self,images , position, surf, myTower,std_size):
        super().__init__(name="Archer", images = images, position = position, elixir = 3,
                         ...
                         target_type = {"air": True, "ground": True, "building": True}, splash_range = 0, size = 0.15,std_size= std_size, attack_speed = FAST_ATTACK,
                         number = 2)
class Giant(Troop):
    def __init__(self,images , position, surf, myTower,std_size):
...
class Balloon(Troop):
    def __init__(self,images , position, surf, myTower, std_size):
        super().__init__(name="Balloon", images  = images, position = position, elixir = 5,
                         ...
                         target_type = {"air": False, "ground": False, "building": True}, splash_range = 1, size = 0.4, std_size= std_size, attack_speed = MEDIUM_ATTACK)
class Prince(Troop):
...
class Barbarian(Troop):
    def __init__(self, position, images , surf, myTower,std_size):
        super().__init__(name="Barbarian", images = images, position = position, elixir = 5,
                         ...
                         target_type = {"air": False, "ground": True, "building": False}, splash_range = 0, size = 0.25,std_size= std_size, attack_speed = MEDIUM_ATTACK,
                         number=5)
